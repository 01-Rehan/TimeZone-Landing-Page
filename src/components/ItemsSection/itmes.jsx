export const Items = () => {
  return (
    <section className="ItemsSection-Container w-scree h-max bg-black  text-white flex flex-wrap justify-center pt-10 ">
      ...
      <div className="ItemsContainer w-11/12 sm:w-10/12 h-max text-white font-extralight pt-10 ">
        ...
        <div className="itemsSection  w-full  h-full flex flex-wrap p-5 justify-center sm:justify-evenly">
            <div className="item w-45 h-80 flex flex-col items-center justify-between  ">
            ...
            <div className="item w-45 h-80 flex flex-col items-center justify-between  ">
                <img src="src\assets\watchPics\image3.png" alt="" className=" h-10/12 object-cover mt-2"/>
            ...
            <div className="item w-45 h-80 hidden sm:flex flex-col items-center justify-between  ">
                <img src="src\assets\watchPics\image2.png" alt="" className=" h-10/12 object-cover mt-1 rotate-90"/>
